...
answer = multiply(4, 8, 55, 49, 65, .05, 100)
print(answer)
...
# Best practice is to name lists with plural nouns and use the singular noun in the for loop
...
# What if you wanted to sort a complex object, such as items, by quantity
items = [
    ("Product1", 10),
    ("Product2", 9),
    ("Product4", 7),
