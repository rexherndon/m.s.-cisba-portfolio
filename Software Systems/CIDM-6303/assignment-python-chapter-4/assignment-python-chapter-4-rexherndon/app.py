...
# Chapter 4.2 Arguments. This chapter demonstrates two arguments. Note that you can't have functions with the same name in the same file, which is why we made greet2().
